...
securityGroupUI = {
    ...
    initButtons: function () {
        ...
        sg.importHelper.setImportEvent("btnOptionImport", sg.dataMigration.SecurityGroupSystem, false, $.noop);
...
var SecurityGroupUtility = {
    ...
    selectionChanged: function (e) {
        ...
        if (dataItem.value != securityGroupUI.securityGroupModel.Data.ProgramId()) {
            ...
            var activeapplication = securityGroupUI.securityGroupModel.Data.ActiveApplication();
            $.each(securityGroupUI.securityGroupModel.Data.ActiveApplication(), function(index, item) {
                if (item.AppId() === securityGroupUI.programId)
                    securityGroupUI.programVersion = item.AppVersion();
            });
    ...
    setSelectedDataForGroupId: function () {
        ...
        securityGroupUI.grid.tbody.find(".selectChk").closest("tr").each(function (index) {
            var gridVal = $(this).find(".gird_culm_6")[0].innerHTML;
    ...
    onDropDownChange: function () {
        ...
        securityGroupUI.securityGroupModel.Data.ProgramVersion(securityGroupUI.programVersion);
